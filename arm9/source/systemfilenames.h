...
#define SFN_SPINBUTTON_L_NAMED SFN_UI_DIRECTORY + gs().uiName + "/spin_btn_named_left.bmp"
#define SFN_SPINBUTTON_R_NAMED SFN_UI_DIRECTORY + gs().uiName + "/spin_btn_named_right.bmp"
#define SFN_SPINBG_L_NAMED SFN_UI_DIRECTORY + gs().uiName + "/spin_bg_named_left.bmp"
...
#define SFN_FILE_INFO_BUTTON SFN_UI_DIRECTORY + gs().uiName + "/file_info.bmp"
...
#define SFN_UI_FOCUS_BL SFN_UI_DIRECTORY + gs().uiName + "/focus_bl.bmp"
