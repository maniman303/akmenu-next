...
class cFont {
  ...
  public:
    ...
    virtual u32 TextHeight(const std::string& aString) const = 0;
    virtual void Draw(u16* mem, s16 x, s16 y, const u8* aText, u16 color, u32 destWidth, u32 destHeight) const = 0;
